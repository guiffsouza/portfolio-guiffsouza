      ...
      <Margin>
        <Linha>
          <BoxMain>
            ...
            <BoxTexto>
              <p>
                Meu primeiro contato com a programação foi com o vba no excel,
                criei uma paixão a partir deste momento, então comecei a estudar
                html, css e javascript.<br></br> Obs: As imagens são meramente
                ilustrativas.
              </p>
            </BoxTexto>
          </BoxMain>
