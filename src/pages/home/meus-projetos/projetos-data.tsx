...
export const ProjetosData: ProjetoData[] = [
  {
    ...
    linguagem: "Python",
    descricao:
      "Bot apelidado de Max para realizar tarefas automaticas entre elas responder mensagens e fazer scrapy de dados. Desenvolvido com linguagem Python. Como todo progama, ainda não finalizado, pois estamos sempre em constante evolução.",
